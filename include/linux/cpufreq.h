...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SKATERACTIVE)
extern struct cpufreq_governor cpufreq_gov_skateractive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_skateractive)
#endif
