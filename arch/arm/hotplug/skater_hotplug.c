...
#define DEFAULT_MAX_CPUS_SCROFF		NR_CPUS / 2
...
static struct skater_hotplug_struct {
	...
	.max_cpus_scroff = DEFAULT_MAX_CPUS_SCROFF,
	.cpufreq_up = 95,
	.cpufreq_down = 80,
	.cycle_up = 1,
	.cycle_down = 1,
...
static void skater_hotplug_suspend(void)
{
	...
	if (num_online_cpus() > skater_hotplug.max_cpus_scroff)
		cpu_down(cpu);
