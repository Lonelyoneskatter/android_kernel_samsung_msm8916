...
#define MAX_ONLINE		NR_CPUS
#define MIN_ONLINE		MAX_ONLINE / 2
#define UP_THRESHOLD		80
#define DEF_PLUG_THRESHOLD	0
#define DEF_DOWN_TIMER_CNT	6	/* 3 secs */
#define DEF_UP_TIMER_CNT	2	/* 1 sec */
#define MAX_CORES_SCREENOFF	MIN_ONLINE
#define MAX_FREQ_SCREENOFF	800000
#define MAX_FREQ_PLUG		1094400
